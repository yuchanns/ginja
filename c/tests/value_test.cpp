...
TEST_F(MiniJinjaTest, SetIntegerValues)
{
    ...
    auto add_result = mj_env_add_template(env, "int_template", "Number: {{ count }}");
...
TEST_F(MiniJinjaTest, SetInt32Values)
{
    ...
    auto add_result = mj_env_add_template(env, "int32_template", "Value: {{ num }}");
    EXPECT_EQ(add_result.error, nullptr);
...
TEST_F(MiniJinjaTest, SetFloat32Values)
{
    ...
    auto add_result = mj_env_add_template(env, "float32_template", "Value: {{ val }}");
    EXPECT_EQ(add_result.error, nullptr);
...
TEST_F(MiniJinjaTest, SetBoolValues)
{
    ...
    auto add_result = mj_env_add_template(env, "bool_template",
...
TEST_F(MiniJinjaTest, SetStringValues)
{
    ...
    auto add_result = mj_env_add_template(env, "string_template", "Hello, {{ name }}!");
    EXPECT_EQ(add_result.error, nullptr);
...
TEST_F(MiniJinjaTest, SetMultipleFieldTypes)
{
    ...
    auto render_result = mj_env_render_template(env, "multi_type_template", value);
    EXPECT_EQ(render_result.error, nullptr);
...
TEST_F(MiniJinjaTest, SetSpecialStringValues)
{
    ...
    auto add_result = mj_env_add_template(env, "special_string_template", "Message: {{ msg }}");
    EXPECT_EQ(add_result.error, nullptr);

    // Test with newlines and special characters
    mj_value_set_string(value, "msg", "Line 1\nLine 2\tTabbed");

    auto render_result = mj_env_render_template(env, "special_string_template", value);
    EXPECT_EQ(render_result.error, nullptr);
...
TEST_F(MiniJinjaTest, SetDeepNestedValues)
{
    ...
    auto render_result = mj_env_render_template(env, "deep_nested_template", value);
    EXPECT_EQ(render_result.error, nullptr);
...
TEST_F(MiniJinjaTest, SetInt16Values)
{
    ...
    auto add_result = mj_env_add_template(env, "int16_template", "Value: {{ num }}");
    EXPECT_EQ(add_result.error, nullptr);
...
TEST_F(MiniJinjaTest, SetInt8Values)
{
    ...
    auto add_result = mj_env_add_template(env, "int8_template", "Value: {{ num }}");
    EXPECT_EQ(add_result.error, nullptr);
...
TEST_F(MiniJinjaTest, SetUintValues)
{
    ...
    auto add_result = mj_env_add_template(env, "uint_template", "Value: {{ num }}");
    EXPECT_EQ(add_result.error, nullptr);
...
TEST_F(MiniJinjaTest, SetUint32Values)
{
    ...
    auto add_result = mj_env_add_template(env, "uint32_template", "Value: {{ num }}");
    EXPECT_EQ(add_result.error, nullptr);
...
TEST_F(MiniJinjaTest, SetUint16Values)
{
    ...
    auto add_result = mj_env_add_template(env, "uint16_template", "Value: {{ num }}");
    EXPECT_EQ(add_result.error, nullptr);
...
TEST_F(MiniJinjaTest, SetUint8Values)
{
    ...
    auto add_result = mj_env_add_template(env, "uint8_template", "Value: {{ num }}");
    EXPECT_EQ(add_result.error, nullptr);
...
TEST_F(MiniJinjaTest, SetListInt16Values)
{
    ...
    auto add_result = mj_env_add_template(env, "list_int16_template",
    ...
    auto render_result = mj_env_render_template(env, "list_int16_template", value);
    EXPECT_EQ(render_result.error, nullptr);
